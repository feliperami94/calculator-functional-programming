...
public class Calculator{
    ...
    public static final DivideInterface divideFunction = (a,b) -> a==0 ? 0 : b==1 ? a : b==0 ? -1 : IntStream.rangeClosed(0,a).reduce((x,y) -> substractFunction.substract(a,x)>=0 ? sumFunction.sum(x,b) : y).getAsInt();
